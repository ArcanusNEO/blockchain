...
alice_txid_to_spend = "adf03845ee8614bdfefc72d515c9b3d53d02a85419e534486aead331f086a698"
alice_utxo_index = 5
alice_amount_to_send = 0.0013

bob_txid_to_spend = "30273bdb233f47c5bc72d07512bcdeb831469f2a373cd7d0c8924e9b344ab48c"
bob_utxo_index = 0
...
btc_test3_chain_height = 2104992

#  curl https://api.blockcypher.com/v1/bcy/test3
bcy_test_chain_height = 40035
...
def atomic_swap(broadcast_transactions=False, alice_redeems=True):
  ...
  bob_signature_BTC = bob.sign_BTC(
      alice_return_coins_tx, alice_swap_scriptPubKey)
  ...
  alice_signature_BCY = alice.sign_BCY(
      bob_return_coins_tx, bob_swap_scriptPubKey)
